<template>
  <div :class="['container', signMode ? '' : 'sign-up-mode']">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <button class="btn transparent" id="sign-up-btn" @click="changeMode">Sign up</button>
        </div>
        <img :src="LogLogo" class="image" alt="" />
      </div>
      <div class="panel right-panel">
        <div class="content">
          ...
          <button class="btn transparent" id="sign-in-btn" @click="changeMode">Sign in</button>
        </div>
        <img :src="RegisterLogo" class="image" alt="A picture here" />
      </div>
    </div>
  </div>
</template>
...
<script setup lang="ts">
  ...
  import LogLogo from '~/assets/log.svg'
  import RegisterLogo from '~/assets/register.svg'

  let signMode: Ref<boolean> = ref(true)
  const changeMode = () => {
